...
// Instructions
var inBG = document.querySelector('#instructionsBG');
	...
	for (var i = 0; i < btns.length; i++) {
		...
		btns[i].addEventListener("click", function() {
		    ...
		    console.log(this.innerText);
				...
				// Instructions
				inBG.classList.remove('moveInstructBG');
				inBG.classList.remove('closeInstructBG');
				inBG.classList.add('insClose');

				btn.classList.remove('addBigI');
				btn.classList.remove('removeBigI');
...
function sideNavigation() {
	var inCon = document.getElementById('instructContain');
	var sideBtns = inCon.getElementsByClassName('steps');

	for (var i = 0; i < sideBtns.length; i++) {

		sideBtns[i].addEventListener("click", function() {

		    var currentTwo = document.getElementsByClassName("sideButtonHere");

		    currentTwo[0].className = currentTwo[0].className.replace(" sideButtonHere", "");

		    this.className += " sideButtonHere";
		    ...
		    if (this.classList.contains('fadeIn')) {
				...
				document.getElementById('stepsContentOne').classList.remove('stepsStyleNone');
				document.getElementById('stepsContentOne').classList.add('stepsStyle');

				document.getElementById('stepsContentTwo').classList.add('stepsStyleNone');
				document.getElementById('stepsContentThree').classList.add('stepsStyleNone');
				document.getElementById('stepsContentFour').classList.add('stepsStyleNone');
				document.getElementById('stepsContentFive').classList.add('stepsStyleNone');

		    }


		    if (this.classList.contains('fadeInTwo')) {

				document.getElementById('stepsContentTwo').classList.remove('stepsStyleNone');
				document.getElementById('stepsContentTwo').classList.add('stepsStyle');

				document.getElementById('stepsContentOne').classList.add('stepsStyleNone');
				document.getElementById('stepsContentThree').classList.add('stepsStyleNone');
				document.getElementById('stepsContentFour').classList.add('stepsStyleNone');
				document.getElementById('stepsContentFive').classList.add('stepsStyleNone');
		    ...
		    if (this.classList.contains('fadeInThree')) {

				document.getElementById('stepsContentThree').classList.remove('stepsStyleNone');
				document.getElementById('stepsContentThree').classList.add('stepsStyle');
		    ...
		    if (this.classList.contains('fadeInFour')) {

				document.getElementById('stepsContentFour').classList.remove('stepsStyleNone');
				document.getElementById('stepsContentFour').classList.add('stepsStyle');
		    ...
		    if (this.classList.contains('fadeInFive')) {

				document.getElementById('stepsContentFive').classList.remove('stepsStyleNone');
				document.getElementById('stepsContentFive').classList.add('stepsStyle');
...
function makeInstructions() {
	...
	var st = document.querySelector('#stepsContent');
	...
	function fadeOut(el){
		...
		btn.classList.remove('addBigI');
		btn.classList.add('removeBigI');
		st.style.display = 'none';
		
		inBG.classList.remove('moveInstructBG');
		inBG.classList.add('closeInstructBG');
	...
	function fadeIn(el, display){
		...
		if (el.classList.contains('instructCont')) {
			...
			btn.classList.add('addBigI');
			btn.classList.remove('removeBigI');
			st.style.display = 'flex';
			
			inBG.classList.add('moveInstructBG');
			inBG.classList.remove('closeInstructBG');
